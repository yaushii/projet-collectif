...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="<?= get_stylesheet_directory_uri(); ?>/img/logo-brasserie-W-reserve.png" />
    ...
    <body <?php body_class(); ?>>
        ...
        <!-- <nav class="navbar navbar-expand-md navbar-light bg-light" role="navigation">
            <div class="container">
                <a class="navbar-brand" href="<?php echo site_url(); ?>"><img src="<?= get_stylesheet_directory_uri(); ?>/img/logo-brasserie-W-reserve.png" alt=""> Brasserie W</a>
